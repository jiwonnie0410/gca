        ...
        <div align="center">
               ...
               <table border="1" width="1200px" bordercolor="#46AA46">
                   <tr>
                       ...
                       <td width="500px">
                        <button class="btn btn-primary px-5 py-3 mt-3" id="reply_save" name="reply_save">댓글 등록</button>
                       </td>
                   </tr>
               </table>
               <table width="1200px">
                   <tr>
                       <td colspan="2" align="right">
                           <button class="btn btn-primary px-5 py-3 mt-3" id="modify" name="modify">글 수정</button>
                           <button class="btn btn-primary px-5 py-3 mt-3" id="delete" name="delete">글 삭제</button>
                           <button class="btn btn-primary px-5 py-3 mt-3" id="list" name="list">게시판</button>                           
                       </td>
                   </tr>
