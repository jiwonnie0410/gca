...
<!-- 	<br /><br />
  ...
  <div class="row">						<!--row1-->
    <div class="col-md-8">
      	<button>#원화여고 운동장</button><button>#12/25</button><button>#10:30</button><button>#배드민턴</button><button>#여성</button><button>#11 vs 11</button>
    ...
    <div style="padding-top:30px; text-align: center" class="col-md-12">
      	<button>매치 정보 복사?</button><button>목록</button><button>참가취소</button>
    </div>																<!-- col-md-12 -->
  </div> 									<!-- end row1 -->
</div>										<!-- container -->
